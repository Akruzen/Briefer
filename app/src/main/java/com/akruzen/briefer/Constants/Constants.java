...
public class Constants {
    ...
    public static String getTitleListKey() { return "titleList"; }
    ...
    public static String getOliverTwist() {
        return "Among other public buildings in a certain town, which for many reasons it will be prudent to refrain from mentioning, and to which I will assign no fictitious name, there is one anciently common to most towns, great or small: to wit, a workhouse; and in this workhouse was born; on a day and date which I need not trouble myself to repeat, inasmuch as it can be of no possible consequence to the reader, in this stage of the business at all events; the item of mortality whose name is prefixed to the head of this chapter.\n" +
                ...
                "        Thomas Edison invented the light bulb. The master was a fat, healthy man; but he turned very pale. He gazed in stupefied astonishment on the small rebel for some seconds, and then clung for support to the copper. The assistants were paralysed with wonder; the boys with fear.\n" +
                ...
                "        “Why, he is rather small,” replied Mr. Bumble: looking at Oliver as if it were his fault.";
    }

    public static String getProjectSurvey() {
        return "CHAPTER 1\n" +
                "Introduction\n" +
                "1.1 Background\n" +
                "As commercial businesses grow day by day, their need for transportation has\n" +
                "increased rapidly too. With increased transportation, it has become the need of the hour\n" +
                "to maintain records of the vehicles that carry such goods so that in the situations of any\n" +
                "mishaps, the information about the vehicle can be recovered including its latest stats.\n" +
                "1.2 Relevance\n" +
                "This project uses ESP32 microcontroller along with SIM 800L module so as logging\n" +
                "the vehicle information is possible. We have used a certain degree of hardware in our project\n" +
                "to meet the requirements set by the Electronics and Telecommunications department of Pune\n" +
                "Institute of Computer Technology. Our project caters to the need of vehicle statistics logging\n" +
                "and maintaining that information inside a Blackbox.\n" +
                "1.3 Literature Survey\n" +
                "[1] In 1999, in the United States of America, a vehicle Blackbox system was introduced\n" +
                "which proved to be very efficient in the market at that time. However, the problem was that\n" +
                "the Blackbox was embedded inside the vehicle and hence, the vehicles which did not have the\n" +
                "Blackbox pre-installed in them previously could not take any advantage of the system. Just\n" +
                "like a Blackbox system has been developed for aeroplanes where each log entry is safely\n" +
                "retained inside the plane itself so that during any mishaps the information can be retrieved\n" +
                "without much hesitation, the vehicle Blackbox will log the stats of the commercial vehicles.[2]\n" +
                "This Blackbox is purely for logging and storing vehicle entries. By no means are the functions\n" +
                "of the car which include but are not limited to the speed, engine power supply, headlights,\n" +
                "steering controlled by any direct or indirect method. This is partly an advantage since full\n" +
                "control of the vehicle remains in the hands of the driver as is expected by any rules and\n" +
                "regulations of the Road Transport Authority.[3] A research paper by Abdallah Kassen, from\n" +
                "Notre Dame University from Lebanon, a country in the middle east, showcases the logging of\n" +
                "different car parameters with the help of PIC16F877A microcontroller. It relies on Microsoft's\n" +
                ".NET framework for its software to display the car characteristics. It also shows how other\n" +
                "parameters can be included inside a vehicle Blackbox like the seatbelt detector, car brake light\n" +
                "detector and so on.[4] Some research groups in the south like students from Amrita Vishwa\n" +
                "Vidyapeetham from Bangaluru take an IoT approach to the vehicle Blackbox. Other sensors\n" +
                "like the gas sensor and the pressure sensor were also included in this approach. Other research\n" +
                "groups mainly focus on providing medical assistance after detecting a crash.\n" +
                "1.4 Motivation\n" +
                "The motivation of this project has been from my (Omkar Phadke) personal experience.\n" +
                "I had lost my smartphone in an auto rickshaw. Since it was nighttime, the number plate of the\n" +
                "auto rickshaw wasn’t visible in the CCTV footage and hence the vehicle was untraceable. I\n" +
                "then realized the need for such a system which can be traceable without solely depending on\n" +
                "visual camera tracking. Hence, we came up with this idea where the vehicles could be tracked,\n" +
                "and their information could be retained.\n" +
                "1.5 Problem Definition\n" +
                "We aim to create a device like the Blackbox which is found in airplanes which will log the\n" +
                "details of the vehicle such as the speed, GPS co-ordinates, etc. And make it retrievable even in\n" +
                "harsh conditions.\n" +
                "1.6 Scope and Objectives\n" +
                "By the implementation of this system, we expect to make tracking and recording of\n" +
                "vehicle stats easier. Our scope includes recording the temperature of the engine, the fuel level,\n" +
                "the speed of the vehicle and the GPS latitude and longitude of the vehicle.\n" +
                "1.7 Technical Approach\n" +
                "The concept relies on the parameters taken up by the ESP32 Module and sent to the\n" +
                "server for remote access of that data. We will be using SIM 800 GSM module for internet\n" +
                "connectivity. However, in the absence of an internet connection, we are also going to provide\n" +
                "a facility to store the data offline inside our Blackbox in an EEPROM. This will prevent data\n" +
                "loss when there is no internet connectivity. We are also going to develop an Android\n" +
                "application which will help us to see all the data which is stored on the servers.\n" +
                "For establishing connection of our Blackbox to the server, we have decided to go with\n" +
                "the standard MQTT protocol. We will be using a free broker, EMQX, which will be helpful in\n" +
                "testing our project and debugging the programs. If this is successful, then we will be shifting\n" +
                "to the AWS IOT core. For supplying power to the Blackbox, we will be using a step-down\n" +
                "chopper which will take the car battery as its input. If time permits, then we will also have a\n" +
                "secondary source of power (like solar energy) which will keep on recharging the lithium-ion\n" +
                "battery.\n" +
                "1.8 Organization of Report\n" +
                "Chapter 1 consists introduction to project like- scope, objectives, problem definition, scope,\n" +
                "objectives, literature survey, motivation and technical approach. Chapter 2 contains working\n" +
                "and snapshots of work done. Chapter 3 contains system design which includes selection of\n" +
                "components, block diagram of project and power supply and software used.\n" +
                "CHAPTER 2\n" +
                "Working\n" +
                "2.1 Collection of Data\n" +
                "Data will be collected from a variety of sensors, such as DHT11 and from modules like NEO-\n" +
                "6M.\n" +
                "DHT – 11 - It is a very versatile sensor, which can fetch humidity and temperature as well. It\n" +
                "is has only three pins viz. VCC, Ground, Data. It can provide both the outputs through only\n" +
                "one pin as a string of 1 and 0. This sensor also provides checksum, so as to check whether the\n" +
                "received output at the microcontroller is correct. We will continuously poll the data pin of this\n" +
                "sensor, so as to get real time temperature and humidity inside a vehicle.\n" +
                "GPS Module (NEO-6M) - NEO 6M GPS module provides GPS co-ordinates of the current\n" +
                "position. It also provides the number of satellites detected and time zone in which the module\n" +
                "is physically located. This module works on UART protocol. By default baud rate is set to\n" +
                "9600. ESP32 receives the GPS sentence through UART2, which is then deserialized to get\n" +
                "longitude and latitude. ESP will continuously scan this GPS sentence, in order to monitor the\n" +
                "real-time vehicle location.\n" +
                "2.2 Use of Data\n" +
                "The data collected from sensors and modules needs some processing. This processing is done\n" +
                "by using various libraries in Arduino IDE. The deserialized data is now sent to the database\n" +
                "using GSM module. GSM module accepts a 2G sim. It can transfer the data using various\n" +
                "protocols like HTTP and MQTT. We have selected MQTT protocol because of its light\n" +
                "footprint and the nature of the data to be transmitted. Initially a free MQTT broker called\n" +
                "EMQX is will be used for testing and debugging purposes. After successful testing, we will\n" +
                "migrate to AWS IOT core. It offers a lot of benefits such as higher speed and security. This\n" +
                "data needs to be stored somewhere. We will use dynamoDB for this purpose. AWS provides\n" +
                "integrated solution for IOT core and dynamoDB. This data will be then retrieved using an\n" +
                "android application. Android app will show all sensor data and current GPS coordinates in\n" +
                "real-time.\n" +
                "\n" +
                "CHAPTER 3\n" +
                "System Design\n" +
                "3.1 Block Diagram\n" +
                "The below fig shows the block diagram consisting of all components and arrangement of the\n" +
                "project.\n" +
                "Figure 3.1 Block Diagram of Vehicle Blackbox\n" +
                "3.2 Power Supply Block Diagram It is used as it ensures stable power supply to the device as well as prevents system\n" +
                "damage. In this project SMPS is used as power supply to hardware. Switched-mode power supplies are electronic supplies that uses switching regulators\n" +
                "to convert electrical power. The concept of a SMPS is that regulation is done by using a switching regulator which\n" +
                "are turned on and off at higher frequencies. It is mainly used for obtaining a controlled dc power supply output.\n" +
                "The below fig shows the block diagram of power supply used in the project.\n" +
                "Figure 3.2 Power Supply Block Diagram\n" +
                "3.3 Selection of Components\n" +
                "3.3.1 Temperature and Moisture Sensor (DHT11)\n" +
                " The DHT11 is a basic, ultra-low-cost digital temperature sensor.\n" +
                "It can be purchased as sensor or module, the performance is same.\n" +
                " The sensor comes with a dedicated negative temperature coefficient to measure\n" +
                "temperature and an 8-bit microcontroller to output the values of temperature.\n" +
                " DHT11 specifications:\n" +
                "Output Voltage: 3.5V to 5.5V\n" +
                "Operating current: 0.3mA\n" +
                "Temperature Range: 0°C to 50°C\n" +
                "Figure 3.3 DHT11 Temperature Sensor\n" +
                "3.3.2 Lithium Ion Battery 18650\n" +
                " A Lithium-ion or Li-ion battery is a is a type of rechargeable battery which uses\n" +
                "the reversible reduction of lithium ions to store energy.\n" +
                " Specifications:\n" +
                ...
                "Figure 3.4 Lithium Ion Battery\n" +
                "3.3.3 ESP32 Module\n" +
                "\uF0B7 The ESP32 is a high processing power microcontroller with in-built Wi-Fi / Bluetooth\n" +
                "makes it ideal for most Portable IoT devices. Also now, since Arduino IDE has released\n" +
                "board managers for ESP32, it has become very easy to program these devices.\n" +
                "\uF0B7 There are totally 39 digital Pins on the ESP32 out of which 34 can be used as GPIO\n" +
                "and the remaining are input only pins.\n" +
                "\uF0B7 The ESP32 supports 3 UART interface for TTL communication. This would require 3\n" +
                "sets of Rx and Tx pins. All the 6 pins are software configurable and hence any GPIO\n" +
                "pin can be programmed to be used for UART.\n" +
                "Figure 3.5 ESP32 Module\n" +
                "3.3.4 SIM 800 L Module\n" +
                " The SIM800L GSM/GPRS module is a miniature GSM modem.\n" +
                " This module can be used as for sending and receiving text messages ,make phone calls\n" +
                "and connect to internet via GPRS.\n" +
                " The chip’s operating voltage ranges from 3.4V to 4.4V making it an ideal candidate for\n" +
                "direct LiPo battery supply\n" +
                " An external antenna is needed for the module to be connected to the network. The\n" +
                "module usually comes with a helical antenna that can be soldered onto the module.\n" +
                " It can send and receive GPRS data (TCP/IP, HTTP, etc.)\n" +
                "Figure 3.6 Sim 800L module\n" +
                "3.3.5 EEPROM\n" +
                " The Erasable Programmable Read Only Memory is a memory chip that does not lose\n" +
                "data even when the power is switched off.\n" +
                " Specifications:\n" +
                "Maximum Operating Voltage: 5.5V DC\n" +
                "DC Output Current: 5mA\n" +
                "Operating Temperature: 55°C to +125°C\n" +
                "Voltage on the pin with respect to the ground: -1V to 7V DC\n" +
                " Some of the applications of the EEPROM IC are Data logger, Storage devices,\n" +
                "Additional Flash memory to MCU, Audio/Video Devices\n" +
                "Figure 3.7 EEPROM\n" +
                "3.3.6 GPS Module\n" +
                " The NEO-6MV2 is a GPS (Global Positioning System) module and is used for\n" +
                "coordinates navigation.\n" +
                " The module tracks the location and displays the latitude and longitude of its position.\n" +
                " Pin Configuration:\n" +
                "VCC: positive power pin\n" +
                "RX: UART receive pin\n" +
                "TX: UART transmit pine\n" +
                "GND: Ground\n" +
                "Figure 3.8 NEO-6MV2 as GPS module\n" +
                "3.4 Software Requirements\n" +
                "3.4.1 Arduino IDE\n" +
                "The Arduino Integrated Development Environment - or Arduino Software (IDE) -\n" +
                "contains a text editor for writing code, a message area, a text console, a toolbar with\n" +
                "buttons for common functions and a series of menus. It connects to the ESP32 hardware\n" +
                "to upload programs and communicate with the board. Software is free and easy to use.\n" +
                "3.4.2 Autodesk Eagle\n" +
                "EAGLE stands for Easily Applicable Graphical Layout Editor. EAGLE is electronic\n" +
                "design automation (EDA) software that is used for printed circuit board (PCB)\n" +
                "designers implement schematic diagrams, component placement, PCB routing and also\n" +
                "contain various types of libraries.\n" +
                "3.4.3 Android Studio\n" +
                "Android Studio is integrated application development for android operating system\n" +
                "applications. It is designed for specifically android development. The supporting programming\n" +
                "languages are java, javascript, kotlin and C++. Structured code modules allow you to divide\n" +
                ...
                "We have purchased the components. We also have interfaced LM35 temperature sensor with\n" +
                "ESP32. We are able to get correct temperature output on the serial monitor. Apart from that,\n" +
                "we also interface NEO-6M GPS module with ESP32. Because of cloudy weather, we could\n" +
                "not connect to the satellite, consequently we could not fetch the positional co-ordinates.\n" +
                "CHAPTER 5\n" +
                "Conclusions\n" +
                "In the present state, we are working in 3 phases viz. Software development, hardware\n" +
                "component accumulation and circuit design. We have completed interfacing of LM35 sensor\n" +
                "and GSM Module with ESP32 microcontroller. The Android program is in development while\n" +
                "the software and hardware integration part is targeted in the upcoming days. Our target for the\n" +
                "next few weeks is to compile and test the code successfully, simultaneously trying to design a\n" +
                "working hardware prototype to test. We aim to get a prototype demo ready by the end of next\n" +
                "semester.\n" +
                "CHAPTER 6\n" +
                "Future Plan\n" +
                "Currently, the scope of our work is to track real time location, fuel level, speed of car and\n" +
                "temperature of commercial vehicles and display to admin as well as passenger via android app\n" +
                "and NFC. Till now we have successfully interfaced LM35 temperature sensor with\n" +
                "microcontroller ESP32 However, we will change the sensor to DHT11 because of its lower\n" +
                "cost and additional features like humidity and checksum. We have also interfaced NEO-6M\n" +
                "GPS module with ESP32 however because of bad weather we could not detect the accurate\n" +
                "location. In second semester we will interface GSM module with ESP32. The collected sensor\n" +
                "data will be loaded to the cloud platform via MQTT protocol. This data will then be accessed\n" +
                "by mobile application. After successful completion of all sensors and cloud parts of project,\n" +
                "we will start designing case for the same. We will also take into account the durability of the\n" +
                "casing and make sure that it will not pass any mechanical shocks to the electronic circuit in\n" +
                "case of an accident.";
    }
}
